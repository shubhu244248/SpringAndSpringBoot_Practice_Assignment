...
public class SpringBoot08MiniProjectOnProfilesApplication {
	...
	public static void main(String[] args) {
		/*//Sprinb boot style
		SpringApplication application=new SpringApplication(SpringBoot08MiniProjectOnProfilesApplication.class);
		//application.setAdditionalProfiles("test","dev");
		ApplicationContext ctx=application.run( args);
		*/

		ApplicationContext ctx = SpringApplication.run(SpringBoot08MiniProjectOnProfilesApplication.class, args);
